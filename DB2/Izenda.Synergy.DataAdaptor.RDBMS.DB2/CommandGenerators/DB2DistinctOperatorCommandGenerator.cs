...
{
    internal class DB2DistinctOperatorCommandGenerator : DistinctOperatorCommandGenerator
    {
        public DB2DistinctOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}