...
{
    internal class DB2JoinOperatorCommandGenerator : JoinOperatorCommandGenerator
    {
        public DB2JoinOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}