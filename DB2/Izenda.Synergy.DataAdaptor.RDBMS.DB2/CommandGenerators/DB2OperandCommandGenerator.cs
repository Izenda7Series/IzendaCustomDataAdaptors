...
{
    internal class DB2OperandCommandGenerator : OperandCommandGenerator
    {
        public DB2OperandCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}