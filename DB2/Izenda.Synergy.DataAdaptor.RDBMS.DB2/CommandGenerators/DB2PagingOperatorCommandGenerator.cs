...
{
    internal class DB2PagingOperatorCommandGenerator : PagingOperatorCommandGenerator
    {
        public DB2PagingOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}