...
{
    internal class DB2ProjectionOperatorCommandGenerator : ProjectionOperatorCommandGenerator
    {
        public DB2ProjectionOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}