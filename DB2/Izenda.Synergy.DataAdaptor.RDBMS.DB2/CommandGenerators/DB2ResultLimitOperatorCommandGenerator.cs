...
{
    internal class DB2ResultLimitOperatorCommandGenerator : ResultLimitOperatorCommandGenerator
    {
        public DB2ResultLimitOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}