...
{
    internal class DB2SelectionOperatorCommandGenerator : SelectionOperatorCommandGenerator
    {
        public DB2SelectionOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}