...
{
    internal class DB2SubTotalOperatorCommandGenerator : SubTotalOperatorCommandGenerator
    {
        public DB2SubTotalOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}