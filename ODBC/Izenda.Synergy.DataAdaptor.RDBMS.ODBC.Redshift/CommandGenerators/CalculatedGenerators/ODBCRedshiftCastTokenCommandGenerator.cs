// ---------------------------------------------------------------------- 
// <copyright file="ODBCRedshiftCastTokenCommandGenerator.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBC.CommandGenerators
{
    ...
    public class ODBCRedshiftCastTokenCommandGenerator : CastTokenCommandGenerator
    {
        /// <summary>
        ...
        public ODBCRedshiftCastTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
