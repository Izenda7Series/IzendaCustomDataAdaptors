// ---------------------------------------------------------------------- 
// <copyright file="ODBCRedshiftConvertTokenCommandGenerator.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBCRedshift.CommandGenerators
{
    ...
    public class ODBCRedshiftConvertTokenCommandGenerator : ConvertTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCConvertTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCRedshiftConvertTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
