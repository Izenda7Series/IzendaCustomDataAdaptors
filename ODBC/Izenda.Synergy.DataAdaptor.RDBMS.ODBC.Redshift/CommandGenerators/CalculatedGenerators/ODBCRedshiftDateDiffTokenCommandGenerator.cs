// ---------------------------------------------------------------------- 
// <copyright file="ODBCRedshiftDateDiffTokenCommandGenerator.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBCRedshift.CommandGenerators
{
    ...
    public class ODBCRedshiftDateDiffTokenCommandGenerator : DateDiffTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCRedshiftDateDiffTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCRedshiftDateDiffTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
