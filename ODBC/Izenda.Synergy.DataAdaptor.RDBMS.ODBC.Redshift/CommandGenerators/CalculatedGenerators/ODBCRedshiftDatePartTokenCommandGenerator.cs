// ---------------------------------------------------------------------- 
// <copyright file="ODBCRedshiftDatePartTokenCommandGenerator.cs" company="Izenda">
...
{
    /// <summary>
    /// ODBCDatePartTokenCommandGenerator
    /// </summary>
    /// <seealso cref="Izenda.BI.DataAdaptor.RDBMS.CommandGenerators.DatePartTokenCommandGenerator" />
    public class ODBCRedshiftDatePartTokenCommandGenerator : DatePartTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCRedshiftDatePartTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCRedshiftDatePartTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
