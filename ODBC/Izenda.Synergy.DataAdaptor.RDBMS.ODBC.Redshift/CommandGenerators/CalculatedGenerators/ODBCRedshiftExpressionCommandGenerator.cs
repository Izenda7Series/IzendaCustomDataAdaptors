// ---------------------------------------------------------------------- 
// <copyright file="ODBCRedshiftExpressionCommandGenerator.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBC.CommandGenerators
{
    ...
    public class ODBCRedshiftExpressionCommandGenerator : ODBCExpressionCommandGenerator
    {
        /// <summary>
        ...
        public override ExpressionCommandGeneratorVisitor ExpressionCommandGeneratorVisitor
        {
            get
            {
                return new ODBCRedshiftExpressionCommandGeneratorVisitor();
            }
        }
    }
}
