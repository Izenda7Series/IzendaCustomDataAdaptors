...
{
    /// <summary>
    /// ODBCRedshiftIsNullTokenCommandGenerator
    /// </summary>
    /// <seealso cref="Izenda.BI.DataAdaptor.RDBMS.CommandGenerators.DateAddTokenCommandGenerator" />
    public class ODBCRedshiftIsNullTokenCommandGenerator : IsNullTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCRedshiftIsNullTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCRedshiftIsNullTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
