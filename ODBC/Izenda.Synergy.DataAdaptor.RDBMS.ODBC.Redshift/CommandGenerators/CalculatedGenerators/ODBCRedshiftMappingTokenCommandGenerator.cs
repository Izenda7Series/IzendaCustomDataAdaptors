...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBCRedshift.CommandGenerators
{
    ...
    public class ODBCRedshiftMappingTokenCommandGenerator : MappingTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RedshiftMappingTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCRedshiftMappingTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
        ...
        public override string ServerTypeId
        {
            get
            {
                return "751A82D4-6B28-406E-AE8E-88035E72D0A8";
            }
        }
    }
}
