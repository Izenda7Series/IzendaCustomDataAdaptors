// ---------------------------------------------------------------------- 
// <copyright file="ODBCRedshiftNullToEmptyConvertor.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBCRedshift.CommandGenerators.ConvertNullToEmptyGenerator
{
    /// <summary>
    /// ODBCRedshiftNullToEmptyConvertor
    /// </summary>    
    public class ODBCRedshiftNullToEmptyConvertor : NullToEmptyConvertor
    {
        /// <summary>
