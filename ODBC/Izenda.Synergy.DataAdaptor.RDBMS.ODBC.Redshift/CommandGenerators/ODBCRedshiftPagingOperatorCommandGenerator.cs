...
{
    public class ODBCRedshiftPagingOperatorCommandGenerator : ODBCPagingOperatorCommandGenerator
    {
        public ODBCRedshiftPagingOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}