// ---------------------------------------------------------------------- 
// <copyright file="ODBCRedshiftSchemaLoader.cs" company="Izenda">
...
{
    [DBServerTypeSupporting("88F5A470-9269-499B-A69C-70C94803FC3E", "ODBC Redshift", "[ODBC] Redshift")]
    public class ODBCRedshiftSchemaLoader : ODBCSchemaLoader
    {
        public override DatabaseSupportDataType DatabaseSupportDataType => new RedshiftSupportDataType();
        ...
        {
            //Return empty list because Redshift does not have conception of store procedure.
