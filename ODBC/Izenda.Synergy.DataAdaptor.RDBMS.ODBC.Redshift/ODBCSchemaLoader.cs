...
{
    [DBServerTypeSupporting("88F5A470-9269-499B-A69C-70C94803FC3E", "ODBC - Redshift", "[ODBC - Redshift] ODBC - Redshift")]
    public class ODBCSchemaLoader : ISchemaLoader
    {
        ...
        {
            return new List<QuerySourceField>();//UNDONE: load fields from procedures - Redshift does not support procedure
            //var result = new List<QuerySourceField>();
