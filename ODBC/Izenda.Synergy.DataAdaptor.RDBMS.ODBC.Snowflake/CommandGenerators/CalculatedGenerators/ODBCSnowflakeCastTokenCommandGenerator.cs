// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeCastTokenCommandGenerator.cs" company="Izenda">
...
{
    /// <summary>
    /// ODBCSnowflakeCastTokenCommandGenerator
    /// </summary>
    /// <seealso cref="Izenda.BI.DataAdaptor.RDBMS.CommandGenerators.CastTokenCommandGenerator" />
    public class ODBCSnowflakeCastTokenCommandGenerator : CastTokenCommandGenerator
    {
        /// <summary>
        ...
        public ODBCSnowflakeCastTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
