// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeConvertTokenCommandGenerator.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.MyODBC.CommandGenerators
{
    ...
    public class ODBCSnowflakeConvertTokenCommandGenerator : ConvertTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCConvertTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCSnowflakeConvertTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
