...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBC.CommandGenerators
{
    ...
    public class ODBCSnowflakeDateAddTokenCommandGenerator : DateAddTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCSnowflakeDateAddTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCSnowflakeDateAddTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
