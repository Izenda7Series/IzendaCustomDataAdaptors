// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeDateDiffTokenCommandGenerator.cs" company="Izenda">
...
{
    /// <summary>
    /// ODBCSnowflakeDateDiffTokenCommandGenerator
    /// </summary>
    /// <seealso cref="Izenda.BI.DataAdaptor.RDBMS.CommandGenerators.DateDiffTokenCommandGenerator" />
    public class ODBCSnowflakeDateDiffTokenCommandGenerator : DateDiffTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCSnowflakeDateDiffTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCSnowflakeDateDiffTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
