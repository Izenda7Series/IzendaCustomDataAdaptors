// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeExpressionCommandGenerator.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBC.CommandGenerators
{
    ...
    public class ODBCSnowflakeExpressionCommandGenerator : ODBCExpressionCommandGenerator
    {
        /// <summary>
        ...
        public override ExpressionCommandGeneratorVisitor ExpressionCommandGeneratorVisitor
        {
            get
            {
                return new ODBCSnowflakeExpressionCommandGeneratorVisitor();
            }
        }
    }
}
