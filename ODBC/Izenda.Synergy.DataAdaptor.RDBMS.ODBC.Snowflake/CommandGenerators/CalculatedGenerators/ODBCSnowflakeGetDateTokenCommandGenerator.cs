// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeGetDateTokenCommandGenerator.cs" company="Izenda">
...
{
    /// <summary>
    /// ODBCSnowflakeGetDateTokenCommandGenerator
    /// </summary>
    /// <seealso cref="Izenda.BI.DataAdaptor.RDBMS.CommandGenerators.DateAddTokenCommandGenerator" />
    public class ODBCSnowflakeGetDateTokenCommandGenerator : ODBCGetDateTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCSnowflakeGetDateTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCSnowflakeGetDateTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
