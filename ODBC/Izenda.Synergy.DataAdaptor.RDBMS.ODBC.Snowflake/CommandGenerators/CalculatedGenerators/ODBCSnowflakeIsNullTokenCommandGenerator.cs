// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeIsNullTokenCommandGenerator.cs" company="Izenda">
...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBCSnowflake.CommandGenerators
{
    ...
    public class ODBCSnowflakeIsNullTokenCommandGenerator : ODBCIsNullTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCSnowflakeIsNullTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCSnowflakeIsNullTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
