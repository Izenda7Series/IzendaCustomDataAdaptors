...
{
    public class ODBCSnowflakePagingOperatorCommandGenerator : ODBCPagingOperatorCommandGenerator
    {
        public ODBCSnowflakePagingOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}