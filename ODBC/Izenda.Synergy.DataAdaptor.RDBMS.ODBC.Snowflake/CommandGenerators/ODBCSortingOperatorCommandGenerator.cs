...
{
    internal class ODBCSortingOperatorCommandGenerator : SortingOperatorCommandGenerator
    {
        public ODBCSortingOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}