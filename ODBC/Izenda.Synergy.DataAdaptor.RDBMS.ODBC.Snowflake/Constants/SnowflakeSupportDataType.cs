...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBCSnowflake.Constants
{
    ...
    public class SnowflakeSupportDataType : DatabaseSupportDataType
    {
        ...
        public SnowflakeSupportDataType()
        {
            ...
            AddDatabaseDataType("DATETIME", IzendaDataType.DatetimeType, true, "System.DateTime", true);
            ...
            //// Numeric
            AddDatabaseDataType("NUMBER", IzendaDataType.NumericType, true, "System.Decimal", true);
            ...
            /// Text
            AddDatabaseDataType("VARCHAR", IzendaDataType.TextType, true, "System.String", true);
