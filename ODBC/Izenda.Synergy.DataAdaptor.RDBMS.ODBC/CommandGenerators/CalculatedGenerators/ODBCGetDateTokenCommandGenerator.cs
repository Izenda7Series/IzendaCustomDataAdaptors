...
{
    /// <summary>
    /// ODBCGetDateTokenCommandGenerator
    /// </summary>
    /// <seealso cref="Izenda.BI.DataAdaptor.RDBMS.CommandGenerators.DateAddTokenCommandGenerator" />
    public class ODBCGetDateTokenCommandGenerator : GetDateTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCGetDateTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCGetDateTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
