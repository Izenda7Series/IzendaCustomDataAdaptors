...
namespace Izenda.BI.DataAdaptor.RDBMS.ODBC.CommandGenerators
{
    ...
    public class ODBCIsNullTokenCommandGenerator : IsNullTokenCommandGenerator
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ODBCIsNullTokenCommandGenerator"/> class.
        /// </summary>
        /// <param name="visitor">The visitor.</param>
        public ODBCIsNullTokenCommandGenerator(ExpressionCommandGeneratorVisitor visitor) : base(visitor)
        {
