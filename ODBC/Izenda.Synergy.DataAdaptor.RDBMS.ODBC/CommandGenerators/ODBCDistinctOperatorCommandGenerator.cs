...
{
    internal class ODBCDistinctOperatorCommandGenerator : DistinctOperatorCommandGenerator
    {
        public ODBCDistinctOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}