...
{
    internal class ODBCOperandCommandGenerator : OperandCommandGenerator
    {
        public ODBCOperandCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}