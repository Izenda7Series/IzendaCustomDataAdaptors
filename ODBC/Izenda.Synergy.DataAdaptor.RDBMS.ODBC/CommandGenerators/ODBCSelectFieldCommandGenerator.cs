...
namespace Izenda.BI.DataAdaptor.RDBMS.CommandGenerators
{
    ...
    /// </summary>
    public class ODBCSelectFieldCommandGenerator : SelectFieldCommandGenerator
    {
        /// <summary>
        /// Contructor
        /// </summary>
        ...
        protected override string SpecificNamespaceForConvertNullToEmpty
        {
            get
            {
                return string.Format(ConvertNullToEmptyNamespace, ".ODBC", ".ODBC", this.GetType().Assembly.GetName().Name);
            }
        }
    }
}
