...
{
    internal class ODBCSelectionOperatorCommandGenerator : SelectionOperatorCommandGenerator
    {
        public ODBCSelectionOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}