...
{
    internal class ODBCSubTotalOperatorCommandGenerator : SubTotalOperatorCommandGenerator
    {
        public ODBCSubTotalOperatorCommandGenerator(QueryTreeCommandGeneratorVisitor visitor) : base(visitor)
        {
        }
    }
}