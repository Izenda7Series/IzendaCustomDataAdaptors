// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeInsertEscapePipeActivity.cs" company="Izenda">
...
namespace Izenda.BI.QueryNormalizer.ODBC
{
    ...
    /// </summary>
    public class ODBCSnowflakeInsertEscapePipeActivity : ODBCSnowflakeQueryNormalizerActivity
    {
        /// <summary>
        /// The activity order
        /// </summary>
