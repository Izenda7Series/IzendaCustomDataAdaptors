// ---------------------------------------------------------------------- 
// <copyright file="ODBCSnowflakeReplaceConcatFunctionActivity.cs" company="Izenda">
...
namespace Izenda.BI.QueryNormalizer.SQL
{
    ...
    /// Replace @ to :
    /// </summary>
    public class ODBCSnowflakeReplaceConcatFunctionActivity : ODBCSnowflakeQueryNormalizerActivity
    {
        /// <summary>
        /// The activity order
        /// </summary>
